...
include:
  - network
  - services.shorewall.base
  - services.shorewall.macros
...
/etc/shorewall/{{ filename }}:
  file.managed:
    - source: salt://services/shorewall/templates/double/{{ filename }}
    - user: root
    - group: root
    - mode: 644
{% endfor %}
...
/etc/default/shorewall:
  file.managed:
    - source: salt://services/shorewall/templates/default
    - user: root
    - group: root
    - mode: 644
